...
<p class="kuang">提示：您正在打开的页面可能被站长弄坏了！推荐您 <a href="{$host}">返回首页</a> 找到开始的路！</p>
<div id="ts404"><img src="{$host}zb_users/theme/{$theme}/style/images/404.png"  align="错误404页面"/></div>
</div>
</body>
</html>