				...
				<div class="article-wrap">
					<div class="article  clearfix">
						<div class="single-post text rich-content">
                                ...
                                <h2>作者:<?php  echo $article->Author->Name;  ?> | 分类:<a href="<?php  echo $article->Category->Url;  ?>"><?php  echo $article->Category->Name;  ?></a> | 浏览:<?php  echo $article->ViewNums;  ?> | 评论:<?php  echo $article->CommNums;  ?></h2>
